{{> cards/card_component componentName='academic_programs' }}

class academic_programsCardComponent extends BaseCard['academic_programs'] {
  ...
  static defaultTemplateName (config) {
    return 'cards/academic_programs';
  }
}

ANSWERS.registerTemplate(
  'cards/academic_programs',
  `{{{read 'cards/academic_programs/template' }}}`
);
ANSWERS.registerComponentType(academic_programsCardComponent);
